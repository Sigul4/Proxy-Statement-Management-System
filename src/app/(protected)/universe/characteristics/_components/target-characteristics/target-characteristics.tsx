...
import ShareTargetCharacteristicsButton from "./share-target-characteristics-button"
import { TargetCharacteristicsChart } from "./target-characteristics-chart"
import TargetCharacteristicsLegend from "./target-characteristics-legend"
import { TargetCharacteristicsTabs } from "./target-characteristics-tabs"
			...
			<header className="flex w-full justify-between gap-5 max-md:max-w-full max-md:flex-wrap">
				<div className="flex w-full justify-between gap-5">
					<div className="flex gap-6 self-stretch text-zinc-900">
						<p className="text-lg font-semibold tracking-wider">Target Characteristics</p>
						<TargetCharacteristicsTabs />
					</div>
					<div>
						<ShareTargetCharacteristicsButton />
					</div>
				</div>
				<div className="flex flex-grow gap-5"></div>
			</header>
			<div className="w-full">
				<TargetCharacteristicsLegend items={datasetsLabels} />
				<TargetCharacteristicsChart data={data} />
			</div>
		</section>
	)
}
