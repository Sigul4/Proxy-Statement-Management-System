...
export default function BoardSetsWonToolbar({ data }: { data: ChartData }) {
	const chart = useOutcomesStore(state => state.boardSetsWonChart)
	...
	return (
		<div className="flex items-center gap-8">
			...
			<div>
				<DownloadSectionAsImageButton name="board-sets-won" chart={chart} elementId="board-sets-won" />
			</div>
		</div>
	)
}
