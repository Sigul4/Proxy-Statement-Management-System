...
export default function ProxyContestResultToolbar({ data }: { data: ChartData }) {
	...
	return (
		<div className="flex items-center gap-8">
			...
			<div>
				<DownloadSectionAsImageButton name="proxy-contest-result" chart={chart} elementId="proxy-contest-result" />
			</div>
		</div>
	)
}
