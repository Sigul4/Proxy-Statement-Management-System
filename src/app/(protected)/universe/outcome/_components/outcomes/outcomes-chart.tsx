...
export default function OutcomesChart({ data }: { data: ChartData }) {
	const setChart = useOutcomesStore(state => state.setOutcomesChart)
	...
	return (
		<canvas ref={canvasRef} className="mt-4 h-[300px] w-full">
